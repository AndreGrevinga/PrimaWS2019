namespace FudgeCraft {
  ...
  export class Control extends f.Node {
    ...
    public static defineControls(): Transformations {
      ...
      controls[f.KEYBOARD_CODE.SHIFT_LEFT] = controls[
        f.KEYBOARD_CODE.SHIFT_RIGHT
      ] = { translation: f.Vector3.Y(1) };
      controls[f.KEYBOARD_CODE.CTRL_LEFT] = controls[
        f.KEYBOARD_CODE.CTRL_RIGHT
      ] = { translation: f.Vector3.Y(-1) };
      return controls;
    }
